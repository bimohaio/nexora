...
Audits record point-in-time evidence, test results, actions, and remaining risks.
They are historical reports rather than normative specifications.

## Contents

- [Phase 1 audit](phase-1-audit.md)
- [Phase 2 audit](phase-2-audit.md)
